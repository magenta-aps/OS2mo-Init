...
class GraphQLClient(AsyncBaseClient):
    ...
    async def classes_query(self) -> ClassesQueryFacets:
        query = gql(
            """
            query ClassesQuery {
              facets {
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return ClassesQuery.parse_obj(data).facets
    ...
    async def _testing_get_class(self, user_key: str) -> TestingGetClassClasses:
        query = gql(
            """

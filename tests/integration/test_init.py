...
from os2mo_init.autogenerated_graphql_client import (
    TestingGetClassClasses as _TestingGetClassClasses,
)
from os2mo_init.autogenerated_graphql_client import (
    TestingGetClassClassesObjects as _TestingGetClassClassesObjects,
)
from os2mo_init.autogenerated_graphql_client import (
    TestingGetClassClassesObjectsCurrent as _TestingGetClassClassesObjectsCurrent,
)
from os2mo_init.autogenerated_graphql_client import (
    TestingGetClassClassesObjectsCurrentFacet as _TestingGetClassClassesObjectsCurrentFacet,
)
from os2mo_init.autogenerated_graphql_client import (
    TestingGetClassClassesObjectsCurrentItSystem as _TestingGetClassClassesObjectsCurrentItSystem,
)
...
async def test_os2mo_init(config_file: Path, graphql_client: GraphQLClient) -> None:
    ...
    case.assertCountEqual(
        facets.dict()["objects"],
        [
            {"current": {"user_key": "address_property"}},
            {"current": {"user_key": "association_type"}},
            {"current": {"user_key": "employee_address_type"}},
            {"current": {"user_key": "engagement_job_function"}},
            {"current": {"user_key": "engagement_type"}},
            {"current": {"user_key": "kle_aspect"}},
            {"current": {"user_key": "kle_number"}},
            {"current": {"user_key": "leave_type"}},
            {"current": {"user_key": "manager_address_type"}},
            {"current": {"user_key": "manager_level"}},
            {"current": {"user_key": "manager_type"}},
            {"current": {"user_key": "org_unit_address_type"}},
            {"current": {"user_key": "org_unit_hierarchy"}},
            {"current": {"user_key": "org_unit_level"}},
            {"current": {"user_key": "org_unit_type"}},
            {"current": {"user_key": "primary_type"}},
            {"current": {"user_key": "responsibility"}},
            {"current": {"user_key": "role"}},
            {"current": {"user_key": "time_planning"}},
            {"current": {"user_key": "visibility"}},
        ],
    )

    # Verify classes
    assert await graphql_client._testing_get_class(
        "PhoneUnit"
    ) == _TestingGetClassClasses(
        objects=[
            _TestingGetClassClassesObjects(
                current=_TestingGetClassClassesObjectsCurrent(
                    facet=_TestingGetClassClassesObjectsCurrentFacet(
                        user_key="org_unit_address_type"
                    ),
                    user_key="PhoneUnit",
                    name="Telefon",
                    scope="PHONE",
                    it_system=_TestingGetClassClassesObjectsCurrentItSystem(
                        user_key="OS2mo"
                    ),
                )
            )
    ...
    assert await graphql_client._testing_get_class("Public") == _TestingGetClassClasses(
        objects=[
            _TestingGetClassClassesObjects(
                current=_TestingGetClassClassesObjectsCurrent(
                    facet=_TestingGetClassClassesObjectsCurrentFacet(
    ...
    assert await graphql_client._testing_get_class("Intern") == _TestingGetClassClasses(
        objects=[
            _TestingGetClassClassesObjects(
                current=_TestingGetClassClassesObjectsCurrent(
                    facet=_TestingGetClassClassesObjectsCurrentFacet(
